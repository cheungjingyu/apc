				...
				<div id='spdv_3607' class='pdv_top'
					...
					<div class="pdv_border"
						...
						<div style="padding: 0px">
							...
							<link href="<%=path %>/qiantai/css/topmenu_bk.css" rel="stylesheet" type="text/css" />

							<div id="topmenu">

								<a href="<%=path %>/user/login.do" target="_self">会员登录</a>| 
								<a href="<%=path %>/user/register.do" target="_self">会员注册</a>| 
								<a href="<%=path %>/user/logout.do">注销退出</a>| 
								<a href="<%=path %>/qiantai/carry.do" target="_self">配送说明</a>| 
								<a href="<%=path %>/qiantai/our.do" target="_self">关于我们</a>
							</div>
				...
				<div id='spdv_3605' class='pdv_top'
					...
					<div class="pdv_border"
						...
						<div style="padding: 0px">
							...
							<link href="<%=path %>/qiantai/css/A.css" rel="stylesheet" type="text/css" />
							...
							<div id="menu">
								...
								<div id="mainmenu">
									<ul>
										...
										<li><a href="<%=path %>" target="_self">首页</a></li>

										<li><a href="<%=path %>/qtcart/index.do" target="_self">我的餐车</a></li>

										<li><a href="<%=path %>/qtorder/myOrder.do" target="_self">我的订单</a></li>
										<li><a href="<%=path %>/user/center.do" target="_self">用户中心</a></li>

										<li><a href="<%=path %>/qiantai/carry.do" target="_self">配送说明</a></li>

										<li><a href="<%=path %>/qiantai/our.do" target="_self">关于我们</a></li>

										<li><a href="<%=path %>/user/logout.do">注销退出</a></li>
			...
			<div id='pdv_3608' class='pdv_class' title=''
				...
				<div id='spdv_3608' class='pdv_top'
					...
					<div class="pdv_border"
						style="margin: 0; padding: 0; height: 100%; border: 0px solid; background:;">
						<div style="padding: 0px">
							<img src="<%=path %>/qiantai/images/1257477260.jpg" alt="" width="100%" border="0" />
						</div>
					</div>
				</div>
			</div>
