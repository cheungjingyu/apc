      ...
      <div id='spdv_391' class='pdv_content' style='overflow:hidden;width:100%;height:100%'>
        <div class="pdv_border" style="margin:0;padding:0;height:100%;border:0px  solid;background:#fff;">
          ...
          <div style="padding:0px">
            <link href="${pageContext.request.contextPath}/qiantai/css/memberlogin_c.css" rel="stylesheet" type="text/css" />
            <div style="width:600px; height:210px;text-align:left;border:1px #f59d5e solid; background-color:#fdebd5;padding:30px;margin:0px">
              <div style="width:210px;float:left;text-align:left;border:1px #f59d5e solid;padding:20px;background-color:#ffffff;">
                <form method="post" action="${pageContext.request.contextPath}/user/login.do" name="form1" onSubmit="ajaxSubmitForm(this,false,'${pageContext.request.contextPath}')">
                  ...
                  <table width="100%"  border="0" cellspacing="0" cellpadding="3">
                    ...
                    <tr>
                      ...
                      <td height="40" ><input name="imageField" type="image" src="<%=path %>/qiantai/images/denglu.gif"  border="0" />
                        <a href="<%=path %>/user/register.do" style="padding-left:1px"><img src="<%=path %>/qiantai/images/zhuce.gif" alt="" width="40" height="19" border="0" /></a></td>
                    </tr>
                  </table>
                </form>
              </div>
              <div style="width:290px;padding:20px;float:right;text-align:left;border:1px #f59d5e solid;background-color:#ffffff;">
                <ul style="margin:0px;padding:0px">
                  <li style=" list-style-type: none;line-height:30px; background:url(<%=path %>/qiantai/images/cateitems.gif) left no-repeat;padding-left:20px"> 如果您已经是会员，请在左侧登录 </li>
                  <li style="list-style-type: none;line-height:30px; background:url(<%=path %>/qiantai/images/cateitems.gif) left no-repeat;padding-left:20px"> 如果您还没有注册会员，<a href="<%=path %>/user/register.do" target="_self"><font color="#FF6600">点这里注册新会员</font></a></li>
                </ul>
              </div>
            </div>
          </div>
